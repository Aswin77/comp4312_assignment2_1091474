...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=assignment02
    """
    try:
        bucket_name = request.args.get('bucket_name', default='assignment02', type=str)
        file_names = []
        file_names = [os.path.basename(path) for path in bucket_name]
